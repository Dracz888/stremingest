...
V._syncSetup = function(){
  const html = `
  <div class="page-head">
    <div><h1>Compartir</h1><div class="sub">Sincroniza tus datos en la nube</div></div>
  </div>
  <div class="note">
...
V._syncHome = function(){
  const html = `
  <div class="page-head">
    <div><h1>Compartir</h1><div class="sub">Crea un espacio o únete a uno</div></div>
  </div>
...
V._syncEditCfg = function(){
  if (!confirm('¿Volver a pegar la configuración de Firebase?')) return;
...
V._syncStatus = function(){
  ...
  const html = `
  <div class="page-head">
    <div><h1>Compartir</h1><div class="sub">Espacio compartido</div></div>
  </div>
...
V._syncLeave = function(){
  if (!confirm('Este teléfono dejará de sincronizar con el espacio. Los datos actuales se quedan guardados aquí. ¿Continuar?')) return;
  Sync.leave();
